package com.example.administrador.metrowaybetter;
...
import com.example.administrador.metrowaybetter.ReadFile;
...
{
        private class Teste extends FragmentActivity implements OnNavigationItemSelectedListener, OnMapReadyCallback {
